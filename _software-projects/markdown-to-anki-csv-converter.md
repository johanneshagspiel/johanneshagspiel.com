...
<img src= "/assets/software-project/markdown-to-anki-csv-converter/markdown-to-anki-csv-converter_logo.JPG" alt="<Markdown-to-Anki-CSV Converter Logo" width="60%" style="display: block; margin: 0 auto">
